...
#############################
class MoCAT(nn.Module):
    def __init__(self, fusion='concat', omic_sizes=[100, 200, 300, 400, 500, 600], n_classes=4, input_dim=768, 
                 model_size_wsi: str='small', model_size_omic: str='small', dropout=0.25,ot_reg=0.1, ot_tau=0.5, ot_impl="pot-uot-l2"):
        super(MoCAT, self).__init__()
        self.fusion = fusion
        ...
        sig_networks = []
        for i in omic_sizes:
            fc_omic = [SNN_Block(dim1=i, dim2=hidden[0])]
