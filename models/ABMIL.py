...
class ABMIL(nn.Module):
    def __init__(self, omic_input_dim=None, fusion=None, size_arg = "small", dropout=0.25, num_class=4, input_dim=768):
        r"""
        Attention MIL Implementation
        ...
        self.fusion = fusion
        self.size_dict_path = {"small": [input_dim, 512, 256], "big": [input_dim, 512, 384]}
