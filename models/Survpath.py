...
class Survpath(nn.Module):
    def __init__(
        ...
        self.return_attn = True     # if return attention
        ...
        #---> wsi props
        self.wsi_embedding_dim = input_dim 
    ...
    def forward(self, **kwargs):
        ...
        attention_scores = { 'attn_pathways':attn_pathways, 'cross_attn_pathways':cross_attn_pathways, 'cross_attn_histology':cross_attn_histology}
        if return_attn:
...
if __name__ == '__main__':
    ...
    model = Survpath().to(device)
    x_path = torch.rand(85, 1024).to(device)
